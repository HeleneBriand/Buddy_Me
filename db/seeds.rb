...
nony1 = Buddy.create!(user_id: user0.id, description: "i'am alone and i suffer i want friends please!", category: "all", city: "marseille")
nony1.photo.attach(io: nony, filename: "nony.jpeg", content_type: "image/jpeg")

mathilde1 = Buddy.create!(user_id: user1.id, description: "i'am alone and i suffer i want friends please!", category: "all", city: "marseille")
...
lulu = Buddy.create!(user_id: user3.id, description: "i'm a good listener", category: "workout", city: "paris")
lulu.photo.attach(io: lucas, filename: "lucas.jpeg", content_type: "image/jpeg")

tonio = Buddy.create!(user_id: user4.id, description: "i like to play and drink a lot", category: "all", city: "marseille")
tonio.photo.attach(io: antoine, filename: "antoine.jpeg", content_type: "image/jpeg")

juju = Buddy.create!(user_id: user5.id, description: "i like to play and drink a lot", category: "all", city: "grenoble")
juju.photo.attach(io: julien, filename: "julien.jpeg", content_type: "image/jpeg")

lulucie = Buddy.create!(user_id: user6.id, description: "i like to play and drink a lot", category: "all", city: "amiens")
lulucie.photo.attach(io: lucie, filename: "lucie.jpeg", content_type: "image/jpeg")

joie = Buddy.create!(user_id: user7.id, description: "i like to play and drink a lot", category: "all", city: "grenoble")
joie.photo.attach(io: joy, filename: "joy.jpeg", content_type: "image/jpeg")

mimi = Buddy.create!(user_id: user8.id, description: "i like to play and drink a lot", category: "all", city: "nice")
mimi.photo.attach(io: mia, filename: "mia.jpeg", content_type: "image/jpeg")

nicolas = Buddy.create!(user_id: user9.id, description: "i like to play and drink a lot", category: "all", city: "toulon")
nicolas.photo.attach(io: nico, filename: "nico.jpeg", content_type: "image/jpeg")

helene1 = Buddy.create!(user_id: user10.id, description: "i like to play and drink a lot", category: "all", city: "paris")
helene1.photo.attach(io: helene, filename: "helene.jpeg", content_type: "image/jpeg")

hermann1 = Buddy.create!(user_id: user11.id, description: "i like to play and drink a lot", category: "all", city: "nimes")
hermann1.photo.attach(io: hermann, filename: "hermann.jpeg", content_type: "image/jpeg")

adri = Buddy.create!(user_id: user12.id, description: "i like to play and drink a lot", category: "all", city: "lyon")
