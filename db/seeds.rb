...
Buddy.create!(user_id: user3.id, description: "I'm a good table tennis player", category: "workout", city: "paris")
Buddy.create!(user_id: user4.id, description: "I like to play and drink a lot", category: "love", city: "marseille")
Buddy.create!(user_id: user5.id, description: "I want to go to India, do you want to come with me?", category: "holidays", city: "grenoble")
Buddy.create!(user_id: user6.id, description: "I love playing squash, do you want to come with me every monday?", category: "workout", city: "amiens")
